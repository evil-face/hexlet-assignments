...
public class App {
    ...
    private static void initDB(Connection connection) throws IOException, SQLException {
        String query = getFileContent("init.sql");
        Statement statement = connection.createStatement();
        statement.execute(query);
        LOGGER.log(Level.INFO, "DB initialization complete");
    }
